...
const Portfolio = () => {
  ...
  return (
    <div className='mt-5 flex justify-center flex-col'>
        ...
        <span className='text-blue-600'>{AppText.Portfolio}</span></h1> */}
        ...
        <div className='flex flex-row justify-evenly gap-2 px-4 md:px-72'>
            ...
            focus:ring-violet-300 focus:bg-blue-600 focus:ring '>All</button>
             <button  onClick={()=>filterPortfolio('ui/ux')}  className='border-blue-600 border-2 
            text-blue-600 focus:text-white
            active:bg-blue-500 p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-blue-600 focus:ring '>UI/UX</button>
             <button onClick={()=>filterPortfolio('website')} className='border-blue-600 border-2 
            text-blue-600 focus:text-white
            active:bg-blue-500 p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-blue-600 focus:ring '>Web App</button>
             <button onClick={()=>filterPortfolio('mobile')} className='border-blue-600 border-2 
            text-blue-600 focus:text-white
            active:bg-blue-500 p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-blue-600 focus:ring '>Mobile App</button>
        </div>
