        ...
        <div className='grid grid-cols-1 md:grid-cols-2 justify-evenly px-10 md:px-44'>
           ...
           <div className='flex flex-col '>
            ...
            <input type="text"  placeholder='yourname@gmail.com'
             className='border-[1.5px] px-2 border-blue-300 
              hover:border-blue-500 rounded-md'  />
            </div>
            <div className='flex flex-col'>
            <label className='text-gray-400 '>Message</label>
            <textarea type="text" rows={7} placeholder='Type your message here'
             className='border-[1.5px] px-2 hover:border-blue-500 border-blue-300 rounded-md'  />
           <button className='transition-all ease-in-out hover:scale-110 bg-blue-500 flex flex-row items-center justify-center text-[14px]  py-1 mt-5 text-white  rounded-md'>
           Submit
